...
class max31865(object):
    ...
    def readTemp(self):
        ...
        temp_C = self.calcAM2315Temp(rtd_ADC_Code)
    ...
    def calcAM2315Temp(self, RTD_ADC_Code):
        ...
        Res_RTD = (RTD_ADC_Code * R_REF) / 32768.0 # AM2315 Resistance
        #print( "AM2315 Resistance: %f ohms" % Res_RTD)
        #
